...
/**
 * @创建人 sgwang
 * @name LogAspectPackage
 * @user 91119
 * @创建时间 2019/6/26
 * @描述 日志统一打印切面 切面service层
 */
@Component
@Aspect
public class LogAspectPackage {

    private static Logger logger = LoggerFactory.getLogger(LogAspectPackage.class);

    private final static String TENANT_KEY = "tenantId";

    @Pointcut("execution (* com.sgwang.service..*.*(..))")
